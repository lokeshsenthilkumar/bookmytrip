...
export default function BookTrain() {
    ...
    const url = 'https://localhost:4000/getTrain/'+params.trainno;  
...
{/* <FormControl variant="filled" className={classes.formControl} style={{padding:"15px",width:"150px"}} >
                        <InputLabel id="demo-simple-select-filled-label" style={{padding:"17px"}}>Gender</InputLabel>
                        <Select
